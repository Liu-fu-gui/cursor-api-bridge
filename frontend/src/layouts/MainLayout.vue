...
const title = computed(() => route.meta.title ?? "Cursor API 转换器｜自用版");
...
const localizedAuthorInfo = computed(() => {
  ...
  if (locale.value === "ja-JP") {
    return {
      ...
      dialogContent: "このプロジェクトは MIT ライセンスで公開されています。",
      dialogConfirmText: "GitHub を開く",
  ...
  return {
    buttonText: "GitHub",
    dialogTitle: "Cursor API Bridge",
    dialogContent: "This project is open source under the MIT License.",
    dialogConfirmText: "Open GitHub",
